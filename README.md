...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://socialify.git.ci/pythonicboat/gitgay.site/image?description=1&font=Raleway&forks=1&issues=1&owner=0&pattern=Solid&stargazers=1&theme=Dark">
    <img src="https://socialify.git.ci/pythonicboat/gitgay.site/image?description=1&font=Raleway&forks=1&issues=1&owner=0&pulls=1&pattern=Solid&stargazers=1&theme=Light">
  </picture>
  <br/>
...
|:-------------------------------------:|:---------------------------------------------------------:|
| ⚡ [`*.gitgay.site`](https://gitgay.site/) | ![cf][badge-cf] ![dnssec][badge-dnssec] ![ssl][badge-ssl] |

> Wildcards (like `*.foo.gitgay.site`) are supported too
...
1. Star and [fork](https://github.com/pythonicboat/gitgay.site/fork) this repository
2. Go to [Webstite](https://gitgay.site)
3. 
...
[actions]:https://github.com/pythonicboat/gitgay.site/actions
[deploy]:https://github.com/pythonicboat/gitgay.site/actions/workflows/deploy.yml
<div align="center">
<a href="https://hits.sh/gitgay.site/"><img alt="Hits" src="https://hits.sh/gitgay.site.svg?label=Visitors&color=555555&labelColor=44cc11"/></a>
</div>
